...
describe("graphql — candidates / fixtures / agent_catalog / freshness / top_holders (#6991)", () => {
  // #7871: candidates(...) now mirrors the sibling gaps(...) field -- it
  // reuses loadCandidatesList, so id/confidence filters, sort/order, and
  // pagination meta come straight from GET /api/v1/candidates.
  const CANDIDATES = {
    generated_at: "2026-07-01T00:00:00.000Z",
    candidates: [
      {
